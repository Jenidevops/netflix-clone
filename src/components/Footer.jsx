export default function Footer() {
  return (
    <footer className="bg-black border-t border-gray-800 px-4 md:px-12 py-12">
      <div className="max-w-6xl mx-auto">
        ...
        <button className="border border-gray-400 text-gray-400 px-4 py-2 text-sm mb-6 hover:border-white hover:text-white">
          Service Code
        </button>
        <p className="text-xs text-gray-400">© 2025 Netflix Clone, Inc.</p>
      </div>
    </footer>
  )
}
